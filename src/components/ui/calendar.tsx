...
import { DayPicker, Day, DayProps, DayPickerSingleProps } from "react-day-picker";
...
export type CalendarProps = DayPickerSingleProps & {
  entries?: { date: Date; emoji: string }[];
};
  ...
  const CustomDay = (dayProps: DayProps) => {
    ...
    return (
      ...
      >
        ...
        {entry && (
          <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-xl pointer-events-none">
            {entry.emoji}
          </span>
        )}
      </div>
