  ...
  return (
    <MainLayout>
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold text-foreground mb-3">Find Your Mental Health Professional</h1>
        ...
        <Tabs defaultValue="find" className="w-full">
          <TabsList className="bg-background border-b rounded-none w-full max-w-md mb-8">
          ...
          <TabsContent value="appointments">
            <div className="flex flex-col items-center justify-center p-12 text-center border rounded-lg bg-muted/30">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">No Current Appointments</h3>
