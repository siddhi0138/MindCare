      ...
      <div className="container mx-auto p-4 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/bhujangasana.gif" alt="Bhujangasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Bhujangasana (Cobra Pose)</h2>
          ...
          {/* Chakrasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/chakrasana.gif" alt="Chakrasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Chakrasana (Wheel Pose)</h2>
              <p className="text-gray-700 text-center">
          ...
          {/* Dhanurasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/Dhanurasana.gif" alt="Dhanurasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Dhanurasana (Bow Pose)</h2>
              <p className="text-gray-700 text-center">
          ...
          {/* Halasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/halasana.gif" alt="Halasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Halasana (Plough Pose)</h2>
              <p className="text-gray-700 text-center">
          ...
          {/* Natarajasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/nataranjasana.gif" alt="Natarajasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Natarajasana (Lord of the Dance Pose)</h2>
              <p className="text-gray-700 text-center">
          ...
          {/* Paschimottanasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/paschimottanasana.gif" alt="Paschimottanasana" className="w-full h-48 object-cover" />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Paschimottanasana (Seated Forward Bend)</h2>
              <p className="text-gray-700 text-center">
          ...
          {/* Sarvangasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/sarvangasana.gif" alt="Sarvangasana" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Shalabhasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/shalabhasana.gif" alt="Shalabhasana" className="w-full h-48 object-cover" />
            <div className="p-6">
          ...
          {/* Uttanasana */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col items-center w-full max-w-sm">
            <img src="/exercises/uttanasana.gif" alt="Uttanasana" className="w-full h-48 object-cover" />
            <div className="p-6">
